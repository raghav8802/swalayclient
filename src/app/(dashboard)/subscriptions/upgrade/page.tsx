...
function Payment() {
  ...
  const plans = [
    ...
    },
    {
      ...
      status: "active",
      features: [
        "Unlimited track & artist releases under your label",
        "Seamless distribution across 50+ Global + Indian Platforms",
        "Album, E.P, or Single – release in your preferred format",
        "Set up Caller Tunes on Airtel, Jio, Vi, BSNL",
        "Maximize earnings with Global & Social Media Monetization",
        "Full YouTube Content ID Protection",
        "Keep 90% of lifetime royalties",
        "Retain 100% Copyright Ownership",
        "Superfast Delivery with Top Priority",
        "Instant availability on Instagram, Facebook, WhatsApp",
        "Social Media Monetization (Instagram/Facebook)",
        "Assistance for Music Profile Verification",
        "Link your music directly with IG & FB artist profiles",
        "Get featured with Premium News Articles & Interviews",
        "Add multiple artists effortlessly to any release",
        "Lyrics Distribution (Platform-dependent)",
        "End-to-end Publishing & Copyright Protection",
